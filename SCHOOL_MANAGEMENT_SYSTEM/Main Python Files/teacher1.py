...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.student_combo_3.setStyleSheet(
            "background-color: rgb(245, 240, 218);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(
            self.tab), _translate("MainWindow", "Lessons"))
        self.label_3.setText(_translate("MainWindow", "Lesson:"))
        self.label_4.setText(_translate("MainWindow", "Student:"))
        self.show_button.setText(_translate(
            "MainWindow", "SHOW STUDENT INFORMATION"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(
            self.tab_2), _translate("MainWindow", "Show student"))

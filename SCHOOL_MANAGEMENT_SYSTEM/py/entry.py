...
"}")
    ...
    def retranslateUi(self, EntryWindow):
        ...
        # Student penceresini açmak için Student Butonuna tıklandığında çalışacak olan fonksiyonu bağlamak icin.

    def openStudentWindow(self):                        # Student penceresini açmak için kullanılan fonksiyon
        self.StudentWindow = QtWidgets.QMainWindow()    # Yeni bir QMainWindow örneği oluşturuluyor ve StudentWindow değişkenine atanıyor.
        self.ui= Ui_StudentWindow()                     # Ui_StudentWindow sınıfından bir örneğin oluşturuluyor ve ui değişkenine atanıyor.
        self.ui.setupUi(self.StudentWindow)             # Ui_StudentWindow örneği üzerindeki setupUi metodunu çağırarak, StudentWindow örneğini ayarlar.
        self.StudentWindow.show()                        # Oluşturulan Student penceresini gösterir.
